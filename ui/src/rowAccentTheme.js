...
export const emeraldRowAccent = {
  ...
  selectionShell: "shadow-[0_0_0_1px_color-mix(in_srgb,var(--color-accent-400)_85%,transparent),0_0_14px_color-mix(in_srgb,var(--color-accent-400)_32%,transparent)]",
  selectionRing: "ring-2 ring-accent-400/45",
...
export const altRowAccents = [
  {
    ...
    selectionShell: "shadow-[0_0_0_1px_rgba(96,165,250,0.85),0_0_14px_rgba(59,130,246,0.32)]",
    selectionRing: "ring-2 ring-blue-400/45",
  ...
  },
  {
    ...
    selectionShell: "shadow-[0_0_0_1px_rgba(251,146,60,0.85),0_0_14px_rgba(249,115,22,0.32)]",
    selectionRing: "ring-2 ring-orange-400/45",
  ...
  },
  {
    ...
    selectionShell: "shadow-[0_0_0_1px_rgba(167,139,250,0.85),0_0_14px_rgba(139,92,246,0.32)]",
    selectionRing: "ring-2 ring-violet-400/45",
