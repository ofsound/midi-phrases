...
export const rowMuteControlClasses = "relative z-20 flex h-[1.9375rem] w-[1.9375rem] shrink-0 items-center justify-center rounded-md border-0 bg-transparent p-0 outline-none focus-visible:ring-1 focus-visible:ring-focus-ring";
