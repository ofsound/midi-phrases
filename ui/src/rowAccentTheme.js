...
export const interfaceAccent = {
  ...
  pianoNoteActive: "border-accent bg-accent shadow-accent-piano-active",
...
export const emeraldRowAccent = {
  ...
  pianoNoteActive: "border-row-accent-1 bg-row-accent-1 shadow-[0_0_12px_color-mix(in_srgb,var(--color-row-accent-1)_65%,transparent)]",
...
export const altRowAccents = [
  {
    ...
    pianoNoteActive: "border-row-accent-2 bg-row-accent-2 shadow-[0_0_12px_color-mix(in_srgb,var(--color-row-accent-2)_65%,transparent)]",
  ...
  },
  {
    ...
    pianoNoteActive: "border-row-accent-3 bg-row-accent-3 shadow-[0_0_12px_color-mix(in_srgb,var(--color-row-accent-3)_65%,transparent)]",
  ...
  },
  {
    ...
    pianoNoteActive: "border-row-accent-4 bg-row-accent-4 shadow-[0_0_12px_color-mix(in_srgb,var(--color-row-accent-4)_65%,transparent)]",
