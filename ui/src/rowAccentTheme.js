...
export const interfaceAccent = {
  ...
  pianoRollSelectionGlow: "shadow-[0_0_0_2px_color-mix(in_srgb,var(--color-accent)_70%,transparent),0_0_14px_color-mix(in_srgb,var(--color-accent)_50%,transparent),0_0_24px_color-mix(in_srgb,var(--color-accent)_28%,transparent)]",
...
export const emeraldRowAccent = {
  ...
  pianoRollSelectionGlow: "shadow-[0_0_0_2px_color-mix(in_srgb,var(--color-row-accent-1)_70%,transparent),0_0_14px_color-mix(in_srgb,var(--color-row-accent-1)_50%,transparent),0_0_24px_color-mix(in_srgb,var(--color-row-accent-1)_28%,transparent)]",
...
export const altRowAccents = [
  {
    ...
    pianoRollSelectionGlow: "shadow-[0_0_0_2px_color-mix(in_srgb,var(--color-row-accent-2)_70%,transparent),0_0_14px_color-mix(in_srgb,var(--color-row-accent-2)_50%,transparent),0_0_24px_color-mix(in_srgb,var(--color-row-accent-2)_28%,transparent)]",
    ...
    pianoNoteIdle: "border-row-accent-2-soft/25 bg-row-accent-2/85 shadow-[inset_0_1px_0_color-mix(in_srgb,var(--color-text)_12%,transparent)]",
    pianoNoteSelected: "border-transparent bg-row-accent-2-strong",
    pianoNoteActive: "border-row-accent-2-strong bg-row-accent-2-strong shadow-[0_0_12px_color-mix(in_srgb,var(--color-row-accent-2)_65%,transparent)]",
  ...
  },
  {
    ...
    pianoRollSelectionGlow: "shadow-[0_0_0_2px_color-mix(in_srgb,var(--color-row-accent-3)_70%,transparent),0_0_14px_color-mix(in_srgb,var(--color-row-accent-3)_50%,transparent),0_0_24px_color-mix(in_srgb,var(--color-row-accent-3)_28%,transparent)]",
    ...
    pianoNoteIdle: "border-row-accent-3-soft/25 bg-row-accent-3/85 shadow-[inset_0_1px_0_color-mix(in_srgb,var(--color-text)_12%,transparent)]",
    pianoNoteSelected: "border-transparent bg-row-accent-3-strong",
    pianoNoteActive: "border-row-accent-3-strong bg-row-accent-3-strong shadow-[0_0_12px_color-mix(in_srgb,var(--color-row-accent-3)_65%,transparent)]",
  ...
  },
  {
    ...
    pianoRollSelectionGlow: "shadow-[0_0_0_2px_color-mix(in_srgb,var(--color-row-accent-4)_70%,transparent),0_0_14px_color-mix(in_srgb,var(--color-row-accent-4)_50%,transparent),0_0_24px_color-mix(in_srgb,var(--color-row-accent-4)_28%,transparent)]",
    ...
    pianoNoteIdle: "border-row-accent-4-soft/25 bg-row-accent-4/85 shadow-[inset_0_1px_0_color-mix(in_srgb,var(--color-text)_12%,transparent)]",
    pianoNoteSelected: "border-transparent bg-row-accent-4-strong",
    pianoNoteActive: "border-row-accent-4-strong bg-row-accent-4-strong shadow-[0_0_12px_color-mix(in_srgb,var(--color-row-accent-4)_65%,transparent)]",
...
export const rowMuteControlClasses = "relative z-20 flex h-[2.1875rem] w-[2.1875rem] shrink-0 items-center justify-center rounded-md border-0 bg-transparent p-0 outline-none focus-visible:ring-1 focus-visible:ring-focus-ring";
...
export const rowActionIconControlClasses = "relative z-20 flex h-[1.75rem] w-[1.75rem] shrink-0 items-center justify-center border-0 bg-transparent p-0 outline-none transition-colors focus:outline-none focus-visible:outline-none";
