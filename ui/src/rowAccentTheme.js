...
export const altRowAccents = [
  {
    ...
    pianoRollSelectionGlow: "shadow-[0_0_0_2px_color-mix(in_srgb,var(--color-row-accent-2)_95%,transparent),0_0_4px_1px_color-mix(in_srgb,var(--color-row-accent-2)_85%,transparent),0_0_10px_2px_color-mix(in_srgb,var(--color-row-accent-2)_60%,transparent)]",
  ...
  },
  {
    ...
    pianoRollSelectionGlow: "shadow-[0_0_0_2px_color-mix(in_srgb,var(--color-row-accent-3)_95%,transparent),0_0_4px_1px_color-mix(in_srgb,var(--color-row-accent-3)_85%,transparent),0_0_10px_2px_color-mix(in_srgb,var(--color-row-accent-3)_60%,transparent)]",
  ...
  },
  {
    ...
    pianoRollSelectionGlow: "shadow-[0_0_0_2px_color-mix(in_srgb,var(--color-row-accent-4)_95%,transparent),0_0_4px_1px_color-mix(in_srgb,var(--color-row-accent-4)_85%,transparent),0_0_10px_2px_color-mix(in_srgb,var(--color-row-accent-4)_60%,transparent)]",
